...
export const translations = {
  en: {
    ...
    updateUpToDate: "Dumbo is up to date",
    updateDownload: "Install & Restart",
  ...
  de: {
    ...
    updateUpToDate: "Dumbo ist auf dem neuesten Stand",
    updateDownload: "Installieren & neu starten",
    ...
    overlayGrabAria: "Overlay verschieben",
